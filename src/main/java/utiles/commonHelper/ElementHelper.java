...
public class ElementHelper {
    ...
    public static List<WebElement> getAllElementsVisible(WebDriver driver, By Locator){
       return waitForVisibilityOfAllElements(driver,Locator);
    }
    public static List<WebElement> getAllElementsPresence(WebDriver driver,By Locator){
        return waitForVisibilityOfElements(driver,Locator);
    }
    ...
    public static void jsClickOnElementByIndex(WebDriver driver,int index, String text){
        WebElement element=findElementByIndex(driver,index,text);
        ((JavascriptExecutor) driver).executeScript("arguments[0].click();", element);
    }
